...
namespace GameLib.Battles
{
    public class Battle
    {
        ...
        public void Start()
        {
            ...
            FirstPlayer.PlacePartyCards();
            SecondPlayer.PlacePartyCards();
        ...
        public void DoTurns(Player firstPlayer, Player secondPlayer)
        {
            Player1.ResetTurnTakenFlags();
            Player2.ResetTurnTakenFlags();
        ...
        private void DoRound(Player firstPlayer, Player secondPlayer)
        {
            ...
            DoTurns(firstPlayer, secondPlayer);
