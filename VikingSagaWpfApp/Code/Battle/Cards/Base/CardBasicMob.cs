...
namespace VikingSagaWpfApp.Code.BattleNs.Cards
{
    ...
    public class CardBasicMob : BattleCard
    {
        ...
        public MobType MobType { get; protected set; }
        public HpChangeType HpChangeType { get; protected set; }
        ...
        {
            Name = "CardBasicMob";
            HpChangeType = Cards.HpChangeType.Physical;
        ...
        private void CheckDodge(ref int amount, HpChangeType changeType)
        {
            if (amount >= 0 || changeType != Cards.HpChangeType.Physical)
                return;
        ...
        private void CheckLifeDrain(int amount)
        {
            ...
            SpellPropertyHpChange(-drainAmount, prop, Cards.HpChangeType.Physical); // Physical, or?
        }
        ...
        private void CheckRegen()
        {
            ...
            SpellPropertyHpChange(amount, prop, Cards.HpChangeType.Physical);
        }
        ...
        private void DoHeal(CardBasicMob dst, int amount)
        {
            ...
            dst.ChangeHp(amount, Cards.HpChangeType.Magic);
        ...
        private void SpellPropertyHpChange(int amount, SpellProperty prop, HpChangeType amountType)
        {
        ...
        public int ChangeHp(int amount, HpChangeType changeType)
        {
